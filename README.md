# Divya Bansal | Data Science Portfolio
...
git clone https://github.com/Divyabansal20/portfolio-website.git
cd portfolio-website

# Run a local web server utilizing python
...
## 📫 Let's Connect
- **LinkedIn**: [in/divya-bansal01](https://linkedin.com/in/divya-bansal01)
- **GitHub**: [Divyabansal20](https://github.com/Divyabansal20)
- **Medium**: [@bansaldivya20082005](https://medium.com/@bansaldivya20082005)

## 📝 License
This project is open-source and free to be adapted or modified under the MIT License.
